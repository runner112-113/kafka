...
object PartitionLeaderElectionAlgorithms {
   ...
   * @param assignment  分区的副本列表。该列表有个专属的名称，叫 Assigned Replicas，简称 AR;AR 是有顺序的，而且不一定和 ISR 的顺序相同
   * @param isr 所有与 Leader 副本保持同步的副本列表;有顺序
   * @param liveReplicas 该分区下所有处于存活状态的副本
